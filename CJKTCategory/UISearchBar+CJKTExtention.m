...
#import "UISearchBar+CJKTExtention.h"

@implementation UISearchBar (CJKTExtention)
// 修改SearchBar系统自带的TextField
- (void)searchBar_changeSearchTextFieldWithCompletionBlock:(void(^)(UITextField *textField))completionBlock {
